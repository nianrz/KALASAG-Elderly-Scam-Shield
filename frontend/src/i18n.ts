...
const en = {
  ...
  'result.messageHidden': 'For your privacy, the full message is not shown again.',
...
const tl: Copy = {
  ...
  'result.messageHidden': 'Para sa privacy niyo po, hindi na ipinapakita ulit ang buong mensahe.',
